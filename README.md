...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 543 | 🐛 1 | 🌐 Python | 📅 2026-09-16 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* [Proximo](https://github.com/john-broadway/proximo) ⭐ 47 | 🐛 2 | 🌐 Python | 📅 2026-09-19 - MCP server for Proxmox VE, Backup Server, Mail Gateway, and Datacenter Manager with audited trust core (plan, prove, undo, diagnose). MCP + A2A.
* [mcp-proxmox](https://github.com/antonio-mello-ai/mcp-proxmox) ⭐ 16 | 🐛 7 | 🌐 Python | 📅 2026-08-17 - MCP server for managing Proxmox VE clusters through AI assistants.

## API

* [Proxmox API documentation](https://pve.proxmox.com/pve-docs/api-viewer/index.html) - Explore the official API documentation.
* Go
  * [Proxmox API Go](https://github.com/Telmate/proxmox-api-go) ⭐ 491 | 🐛 55 | 🌐 Go | 📅 2026-09-14 - Proxmox API in golang. For /api2/json.
  * [go-proxmox](https://github.com/luthermonson/go-proxmox) ⭐ 289 | 🐛 2 | 🌐 Go | 📅 2026-08-09 - Typed Go client for the Proxmox VE REST API.
* Java
...
* Python
  * [proxmox-sdk](https://github.com/emersonfelipesp/proxmox-sdk) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-09-17 - Schema-driven FastAPI package, Python SDK, and CLI/TUI for Proxmox APIs: OpenAPI generation, mock data, SQLite/WAL-backed CRUD operations, typed service facades, and real API connections.
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 524 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,611 | 🐛 19 | 🌐 Shell | 📅 2026-09-19 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,981 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-19 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,922 | 🐛 24 | 🌐 Shell | 📅 2026-09-19 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
* [Proxmox-Enhanced-Configuration-Utility (PECU)](https://github.com/Danilop95/Proxmox-Enhanced-Configuration-Utility) ⭐ 974 | 🐛 10 | 🌐 Shell | 📅 2026-05-17 - Versatile Bash script to simplify and optimize configuration and management of Proxmox VE systems.
...
* [dockur/proxmox](https://github.com/dockur/proxmox) ⭐ 313 | 🐛 4 | 🌐 Shell | 📅 2026-08-30 - Full Proxmox VE node running inside a Docker container, for labs and CI.
...
* [Proxmox Manager](https://github.com/TimInTech/proxmox-manager) ⭐ 80 | 🐛 2 | 🌐 Shell | 📅 2026-08-31 - Single-file Bash tool for managing Proxmox VMs and containers.
...
* [ProxLB](https://github.com/credativ/ProxLB) ⭐ 164 | 🐛 12 | 🌐 Python | 📅 2026-09-17 - Application to optimize the distribution of virtual machines across Proxmox cluster nodes for enhanced efficiency and performance.
...
* [VirtDeck](https://github.com/mcluremail/virtdeck) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Native desktop client for Proxmox VE: monitoring, VM/container management, backups and direct Proxmox Backup Server integration (PySide6, Windows and Linux).

## Documentation

* [10 Ways to Ruin Your Proxmox Setup - And How Not To](https://github.com/SwamiRama/10-ways-to-ruin-proxmox) ⭐ 161 | 🐛 1 | 📅 2026-01-05 - Book about 10 common mistakes and how to avoid them.
...
* [pve-microvm](https://github.com/rcarmo/pve-microvm) ⭐ 388 | 🐛 1 | 🌐 Shell | 📅 2026-09-14 - Firecracker-like microVMs for Proxmox VE — KVM isolation, under 200ms boot.
* [osx-proxmox](https://github.com/lucid-fabrics/osx-proxmox-next) ⭐ 274 | 🐛 1 | 🌐 Python | 📅 2026-09-19 - One-command macOS VM automation for Proxmox 9 with TUI wizard, recovery image auto-download, and AMD/Intel CPU support for Sonoma, Sequoia, and Tahoe.
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,233 | 🐛 103 | 🌐 Go | 📅 2026-09-19 - Terraform provider which adds support for Proxmox solutions.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 587 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 - Self-contained GitOps environment for provisioning and orchestrating Linux Containers (LXC) on Proxmox VE.
* [Cluster API Provider for Proxmox VE (CAPMOX)](https://github.com/ionos-cloud/cluster-api-provider-proxmox) ⭐ 483 | 🐛 119 | 🌐 Go | 📅 2026-09-18 - Kubernetes-style declarative APIs for cluster creation, configuration, and management on Proxmox VE.
* [Pulumi Proxmox VE](https://github.com/muhlba91/pulumi-proxmoxve) ⭐ 226 | 🐛 25 | 🌐 Go | 📅 2026-09-18 - Pulumi provider for creating and managing Proxmox VE resources.
...
* [Ansible Collection - community.proxmox](https://github.com/ansible-collections/community.proxmox) ⭐ 144 | 🐛 87 | 🌐 Python | 📅 2026-09-17 - Canonical Ansible collection for managing Proxmox VE clusters, VMs, and containers.
...
* [Netbox-SSOT](https://github.com/bl4ko/netbox-ssot) ⭐ 74 | 🐛 9 | 🌐 Go | 📅 2026-09-19 - Microservice that syncs objects from multiple sources (including Proxmox) into NetBox as automatic SSOT
...
* [ferrum](https://github.com/anand34577/ferrum) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - Fleet control for Proxmox VE — a single dashboard for every cluster and standalone node you run, with live inventory, dashboards, backups, HA , firewall, alerting, and more. ([docs](https://anand34577.github.io/ferrum/guide/index.html)).
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,727 | 🐛 62 | 🌐 Go | 📅 2026-09-17 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
* [Prometheus Proxmox VE Exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) ⭐ 1,449 | 🐛 36 | 🌐 Python | 📅 2026-09-16 - Exporter that exposes information gathered from Proxmox VE nodes for use by the Prometheus monitoring system.
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 269 | 🐛 4 | 🌐 Python | 📅 2026-09-17 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
* [check\_pve](https://github.com/nbuchwitz/check_pve) ⭐ 134 | 🐛 12 | 🌐 Python | 📅 2026-09-10 - Icinga check command for Proxmox VE via API.
...
* [Proxmox on NixOS](https://github.com/SaumonNet/proxmox-nixos) ⭐ 1,385 | 🐛 32 | 🌐 Nix | 📅 2026-09-12 - Unofficial port of the Proxmox Hypervisor on NixOS.
...
* [Proxmox VE Custom Integration for Home Assistant](https://github.com/dougiteixeira/proxmoxve) ⭐ 965 | 🐛 12 | 🌐 Python | 📅 2026-09-19 - This integration allows you to poll various data and controls from your Proxmox VE instance.
* [Proxmox Extended Sensors (v4)](https://github.com/Javisen/proxmox_sensors) ⭐ 66 | 🐛 4 | 🌐 Python | 📅 2026-09-19 - Detailed monitoring & control system for Proxmox VE & PBS in Home Assistant.
...
* [Proxmox Hardening Guide](https://github.com/HomeSecExplorer/Proxmox-Hardening-Guide) ⭐ 561 | 🐛 0 | 📅 2026-02-09 - Security hardening guides for PVE and PBS, built on CIS Debian Benchmark with Proxmox specific best practices.
...
* [TrueNAS Proxmox VE Storage Plugin](https://github.com/truenas/truenas-proxmox-plugin) ⭐ 314 | 🐛 45 | 🌐 Shell | 📅 2026-09-19 - High-performance storage plugin for Proxmox VE that integrates TrueNAS SCALE via iSCSI, featuring live snapshots, ZFS integration, and cluster compatibility.
* [ANAS](https://github.com/ccebelenski/anas) ⭐ 161 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-15 - The storage layer Proxmox VE doesn't have, inside the Proxmox web UI. ZFS and mixed-size Hybrid RAID pools, SMB/NFS shares, an iSCSI target, snapshots and schedules, replication, backup and restore to PBS — as native panels on the PVE node.
...
* [SharedLVM](https://github.com/delltech1/proxmox-sharedlvmthin) ⭐ 12 | 🐛 0 | 🌐 Perl | 📅 2026-09-18 - Snapshot-capable shared FC/iSCSI SAN storage for Proxmox VE 9 clusters, with Thin Pools and Thick Generations over an existing shared LVM VG.
...
* [PVE-VDIClient](https://github.com/joshpatten/PVE-VDIClient) ⭐ 1,093 | 🐛 44 | 🌐 Python | 📅 2026-04-10 - Proxmox based VDI client.
...
Contributing guidelines can be found [here](https://github.com/alexgoesgit/awesome-proxmox-ve-virtualization/blob/main/contributing.md) ⭐ 85 | 🐛 0 | 📅 2026-09-19.
