...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 511 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
* [ProxmoxMCP](https://github.com/canvrno/proxmoxmcp) ⭐ 288 | 🐛 15 | 🌐 Python | 📅 2025-02-19 - Python-based MCP server for interacting with Proxmox hypervisors, providing a clean interface for managing nodes, VMs, and containers.
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 514 | 🐛 2 | 🌐 Go | 📅 2026-08-28 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,426 | 🐛 25 | 🌐 Shell | 📅 2026-08-29 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,918 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-29 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,895 | 🐛 16 | 🌐 Shell | 📅 2026-08-23 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
...
* [dockur/proxmox](https://github.com/dockur/proxmox) ⭐ 300 | 🐛 3 | 🌐 Shell | 📅 2026-08-29 - Full Proxmox VE node running inside a Docker container, for labs and CI.
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,202 | 🐛 118 | 🌐 Go | 📅 2026-08-29 - Terraform provider which adds support for Proxmox solutions.
...
* [Reeve](https://github.com/JoshuaShunk/reeve) ⭐ 58 | 🐛 5 | 🌐 Swift | 📅 2026-07-13 - Native SwiftUI app for iOS and MacOS to monitor, manage, and automate a Proxmox VE homelab.
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,638 | 🐛 20 | 🌐 Go | 📅 2026-08-29 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
* [Prometheus Proxmox VE Exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) ⭐ 1,445 | 🐛 32 | 🌐 Python | 📅 2026-08-28 - Exporter that exposes information gathered from Proxmox VE nodes for use by the Prometheus monitoring system.
...
* [PVE-VDIClient](https://github.com/joshpatten/PVE-VDIClient) ⭐ 1,086 | 🐛 44 | 🌐 Python | 📅 2026-04-10 - Proxmox based VDI client.
