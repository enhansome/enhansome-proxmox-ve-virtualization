...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 497 | 🐛 1 | 🌐 Python | 📅 2026-08-11 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 510 | 🐛 5 | 🌐 Go | 📅 2026-08-24 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
* [Joulenap](https://github.com/Joulenap/joulenap) ⭐ 122 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Web UI and scheduler for backups to a Proxmox Backup Server that stays powered off: wakes it, runs the backups, prunes, garbage-collects and shuts it down. Any number of PVE hosts and PBS, PBS to PBS sync, notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,380 | 🐛 29 | 🌐 Shell | 📅 2026-08-24 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,903 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-24 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,883 | 🐛 16 | 🌐 Shell | 📅 2026-08-23 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
* [Proxmox-Enhanced-Configuration-Utility (PECU)](https://github.com/Danilop95/Proxmox-Enhanced-Configuration-Utility) ⭐ 962 | 🐛 10 | 🌐 Shell | 📅 2026-05-17 - Versatile Bash script to simplify and optimize configuration and management of Proxmox VE systems.
* [pvetui](https://github.com/devnullvoid/pvetui) ⭐ 712 | 🐛 12 | 🌐 Go | 📅 2026-08-24 - Terminal User Interface for Proxmox Virtual Environment.
...
* [ProxmoxBar](https://github.com/ryzenixx/proxmoxbar-macos) ⭐ 177 | 🐛 0 | 🌐 Swift | 📅 2026-08-14 - Native macOS menu bar app for monitoring and controlling Proxmox VE resources.
...
* [pve-microvm](https://github.com/rcarmo/pve-microvm) ⭐ 358 | 🐛 1 | 🌐 Shell | 📅 2026-08-24 - Firecracker-like microVMs for Proxmox VE — KVM isolation, under 200ms boot.
* [osx-proxmox](https://github.com/lucid-fabrics/osx-proxmox-next) ⭐ 258 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - One-command macOS VM automation for Proxmox 9 with TUI wizard, recovery image auto-download, and AMD/Intel CPU support for Sonoma, Sequoia, and Tahoe.
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,198 | 🐛 116 | 🌐 Go | 📅 2026-08-23 - Terraform / OpenTofu provider which adds support for Proxmox solutions.
...
* [Cluster API Provider for Proxmox VE (CAPMOX)](https://github.com/ionos-cloud/cluster-api-provider-proxmox) ⭐ 475 | 🐛 114 | 🌐 Go | 📅 2026-08-19 - Kubernetes-style declarative APIs for cluster creation, configuration, and management on Proxmox VE.
...
* [Netbox-SSOT](https://github.com/bl4ko/netbox-ssot) ⭐ 74 | 🐛 6 | 🌐 Go | 📅 2026-08-24 - Microservice that syncs objects from multiple sources (including Proxmox) into NetBox as automatic SSOT
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,612 | 🐛 25 | 🌐 Go | 📅 2026-08-24 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
* [Prometheus Proxmox VE Exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) ⭐ 1,438 | 🐛 38 | 🌐 Python | 📅 2026-08-19 - Exporter that exposes information gathered from Proxmox VE nodes for use by the Prometheus monitoring system.
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 178 | 🐛 7 | 🌐 Python | 📅 2026-08-22 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
...
* [Proxmox Hardening Guide](https://github.com/HomeSecExplorer/Proxmox-Hardening-Guide) ⭐ 543 | 🐛 0 | 📅 2026-02-09 - Security hardening guides for PVE and PBS, built on CIS Debian Benchmark with Proxmox specific best practices.
...
Contributing guidelines can be found [here](https://github.com/alexgoesgit/awesome-proxmox-ve-virtualization/blob/main/contributing.md) ⭐ 79 | 🐛 0 | 📅 2026-08-20.
