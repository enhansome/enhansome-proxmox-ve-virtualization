...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 516 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* [Proximo](https://github.com/john-broadway/proximo) ⭐ 41 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - MCP server for Proxmox VE, Backup Server, Mail Gateway, and Datacenter Manager with audited trust core (plan, prove, undo, diagnose). MCP + A2A.
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 515 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,465 | 🐛 17 | 🌐 Shell | 📅 2026-09-01 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,925 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-01 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,898 | 🐛 19 | 🌐 Shell | 📅 2026-08-23 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
* [Proxmox-Enhanced-Configuration-Utility (PECU)](https://github.com/Danilop95/Proxmox-Enhanced-Configuration-Utility) ⭐ 965 | 🐛 10 | 🌐 Shell | 📅 2026-05-17 - Versatile Bash script to simplify and optimize configuration and management of Proxmox VE systems.
* [pvetui](https://github.com/devnullvoid/pvetui) ⭐ 718 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - Terminal User Interface for Proxmox Virtual Environment.
* [PVE Scripts Local](https://github.com/community-scripts/ProxmoxVE-Local) ⭐ 373 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-21 - Local web UI to browse and run Proxmox VE Helper-Scripts without curl-to-bash from the site.
* [dockur/proxmox](https://github.com/dockur/proxmox) ⭐ 303 | 🐛 4 | 🌐 Shell | 📅 2026-08-30 - Full Proxmox VE node running inside a Docker container, for labs and CI.
...
* [pve-microvm](https://github.com/rcarmo/pve-microvm) ⭐ 368 | 🐛 2 | 🌐 Shell | 📅 2026-08-24 - Firecracker-like microVMs for Proxmox VE — KVM isolation, under 200ms boot.
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,207 | 🐛 114 | 🌐 Go | 📅 2026-09-01 - Terraform provider which adds support for Proxmox solutions.
...
* [Ansible Collection - community.proxmox](https://github.com/ansible-collections/community.proxmox) ⭐ 142 | 🐛 86 | 🌐 Python | 📅 2026-08-24 - Canonical Ansible collection for managing Proxmox VE clusters, VMs, and containers.
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,655 | 🐛 33 | 🌐 Go | 📅 2026-09-01 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
...
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 201 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
...
* [Proxmox Hardening Guide](https://github.com/HomeSecExplorer/Proxmox-Hardening-Guide) ⭐ 549 | 🐛 0 | 📅 2026-02-09 - Security hardening guides for PVE and PBS, built on CIS Debian Benchmark with Proxmox specific best practices.
