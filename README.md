...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 530 | 🐛 1 | 🌐 Python | 📅 2026-09-12 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* [Proximo](https://github.com/john-broadway/proximo) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2026-09-13 - MCP server for Proxmox VE, Backup Server, Mail Gateway, and Datacenter Manager with audited trust core (plan, prove, undo, diagnose). MCP + A2A.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,567 | 🐛 22 | 🌐 Shell | 📅 2026-09-13 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,971 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-13 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,912 | 🐛 19 | 🌐 Shell | 📅 2026-09-13 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
...
* [dockur/proxmox](https://github.com/dockur/proxmox) ⭐ 308 | 🐛 4 | 🌐 Shell | 📅 2026-08-30 - Full Proxmox VE node running inside a Docker container, for labs and CI.
...
* [pve-microvm](https://github.com/rcarmo/pve-microvm) ⭐ 380 | 🐛 0 | 🌐 Shell | 📅 2026-09-05 - Firecracker-like microVMs for Proxmox VE — KVM isolation, under 200ms boot.
* [osx-proxmox](https://github.com/lucid-fabrics/osx-proxmox-next) ⭐ 269 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - One-command macOS VM automation for Proxmox 9 with TUI wizard, recovery image auto-download, and AMD/Intel CPU support for Sonoma, Sequoia, and Tahoe.
* [valheim-proxmox](https://github.com/PawelSzymanski89/valheim-proxmox) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - One-command Valheim dedicated server LXC with a web panel for players, bans, worlds, backups and mods
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,225 | 🐛 100 | 🌐 Go | 📅 2026-09-12 - Terraform provider which adds support for Proxmox solutions.
...
* [Ansible Collection - community.proxmox](https://github.com/ansible-collections/community.proxmox) ⭐ 143 | 🐛 89 | 🌐 Python | 📅 2026-09-10 - Canonical Ansible collection for managing Proxmox VE clusters, VMs, and containers.
...
* [Netbox-SSOT](https://github.com/bl4ko/netbox-ssot) ⭐ 74 | 🐛 10 | 🌐 Go | 📅 2026-09-13 - Microservice that syncs objects from multiple sources (including Proxmox) into NetBox as automatic SSOT
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,701 | 🐛 46 | 🌐 Go | 📅 2026-09-13 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
...
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 231 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
