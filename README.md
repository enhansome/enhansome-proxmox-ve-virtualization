...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 524 | 🐛 0 | 🌐 Python | 📅 2026-09-04 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* [Proximo](https://github.com/john-broadway/proximo) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - MCP server for Proxmox VE, Backup Server, Mail Gateway, and Datacenter Manager with audited trust core (plan, prove, undo, diagnose). MCP + A2A.
...
* [Proxmox VM Autoscale](https://github.com/fabriziosalmi/proxmox-vm-autoscale) ⭐ 304 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Service that dynamically adjusts your Proxmox virtual machine (VM) resources (CPU cores, RAM) based on real-time metrics and user-defined thresholds.
* [LXC AutoScale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 258 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - Resource management daemon specifically designed for Proxmox environments. It automatically adjusts CPU and memory allocations with no downtime and can clone LXC containers based on real-time usage metrics and predefined thresholds.

## Backup Tools

* [cv4pve-autosnap](https://github.com/Corsinvest/cv4pve-autosnap) ⭐ 564 | 🐛 3 | 🌐 C# | 📅 2026-07-03 - Automatic snapshots for VMs and containers with retention policies, via the Proxmox API.
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 515 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
* [Joulenap](https://github.com/Joulenap/joulenap) ⭐ 125 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Web UI and scheduler for backups to a Proxmox Backup Server that stays powered off: wakes it, runs the backups, prunes, garbage-collects and shuts it down. Any number of PVE hosts and PBS, PBS to PBS sync, notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,519 | 🐛 19 | 🌐 Shell | 📅 2026-09-08 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,959 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-08 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,904 | 🐛 21 | 🌐 Shell | 📅 2026-08-23 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
* [Proxmox-Enhanced-Configuration-Utility (PECU)](https://github.com/Danilop95/Proxmox-Enhanced-Configuration-Utility) ⭐ 970 | 🐛 10 | 🌐 Shell | 📅 2026-05-17 - Versatile Bash script to simplify and optimize configuration and management of Proxmox VE systems.
* [pvetui](https://github.com/devnullvoid/pvetui) ⭐ 720 | 🐛 17 | 🌐 Go | 📅 2026-09-07 - Terminal User Interface for Proxmox Virtual Environment.
* [PVE Scripts Local](https://github.com/community-scripts/ProxmoxVE-Local) ⭐ 374 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - Local web UI to browse and run Proxmox VE Helper-Scripts without curl-to-bash from the site.
...
* [Proxmox VMID Updater](https://github.com/sannier3/proxmox-vmid-updater) ⭐ 14 | 🐛 0 | 🌐 Shell | 📅 2026-06-29 - Interactive Proxmox VM/LXC ID renaming script with automatic logging, safety checks, and storage path updates.

## Cluster Tools

* [ProxLB](https://github.com/credativ/ProxLB) ⭐ 163 | 🐛 10 | 🌐 Python | 📅 2026-08-31 - Application to optimize the distribution of virtual machines across Proxmox cluster nodes for enhanced efficiency and performance.
...
* [ProxmoxBar](https://github.com/ryzenixx/proxmoxbar-macos) ⭐ 180 | 🐛 2 | 🌐 Swift | 📅 2026-09-02 - Native macOS menu bar app for monitoring and controlling Proxmox VE resources.

## Documentation

* [10 Ways to Ruin Your Proxmox Setup - And How Not To](https://github.com/SwamiRama/10-ways-to-ruin-proxmox) ⭐ 160 | 🐛 1 | 📅 2026-01-05 - Book about 10 common mistakes and how to avoid them.
...
* [pve-microvm](https://github.com/rcarmo/pve-microvm) ⭐ 375 | 🐛 0 | 🌐 Shell | 📅 2026-09-05 - Firecracker-like microVMs for Proxmox VE — KVM isolation, under 200ms boot.
* [osx-proxmox](https://github.com/lucid-fabrics/osx-proxmox-next) ⭐ 269 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - One-command macOS VM automation for Proxmox 9 with TUI wizard, recovery image auto-download, and AMD/Intel CPU support for Sonoma, Sequoia, and Tahoe.
* [valheim-proxmox](https://github.com/PawelSzymanski89/valheim-proxmox) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - One-command Valheim dedicated server LXC with a web panel for players, bans, worlds, backups and mods
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,217 | 🐛 98 | 🌐 Go | 📅 2026-09-08 - Terraform provider which adds support for Proxmox solutions.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 582 | 🐛 0 | 🌐 Ruby | 📅 2026-08-30 - Self-contained GitOps environment for provisioning and orchestrating Linux Containers (LXC) on Proxmox VE.
* [Cluster API Provider for Proxmox VE (CAPMOX)](https://github.com/ionos-cloud/cluster-api-provider-proxmox) ⭐ 478 | 🐛 114 | 🌐 Go | 📅 2026-09-08 - Kubernetes-style declarative APIs for cluster creation, configuration, and management on Proxmox VE.
* [Pulumi Proxmox VE](https://github.com/muhlba91/pulumi-proxmoxve) ⭐ 226 | 🐛 23 | 🌐 Go | 📅 2026-09-06 - Pulumi provider for creating and managing Proxmox VE resources.
* [Hashicorp packer-plugin-proxmox](https://github.com/hashicorp/packer-plugin-proxmox) ⭐ 223 | 🐛 92 | 🌐 Go | 📅 2026-09-07 - Official HashiCorp Packer plugin for building Proxmox VM templates.
* [Ansible Collection - community.proxmox](https://github.com/ansible-collections/community.proxmox) ⭐ 142 | 🐛 90 | 🌐 Python | 📅 2026-08-24 - Canonical Ansible collection for managing Proxmox VE clusters, VMs, and containers.
...
* [Netbox-SSOT](https://github.com/bl4ko/netbox-ssot) ⭐ 74 | 🐛 9 | 🌐 Go | 📅 2026-09-07 - Microservice that syncs objects from multiple sources (including Proxmox) into NetBox as automatic SSOT
...
* [Reeve](https://github.com/JoshuaShunk/reeve) ⭐ 60 | 🐛 6 | 🌐 Swift | 📅 2026-07-13 - Native SwiftUI app for iOS and MacOS to monitor, manage, and automate a Proxmox VE homelab.
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,678 | 🐛 44 | 🌐 Go | 📅 2026-09-08 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
...
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 217 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
* [check\_pve](https://github.com/nbuchwitz/check_pve) ⭐ 134 | 🐛 11 | 🌐 Python | 📅 2026-02-05 - Icinga check command for Proxmox VE via API.
* [pbs-exporter](https://github.com/natrontech/pbs-exporter) ⭐ 60 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - Prometheus exporter for Proxmox Backup Server.
...
* [cv4pve-report](https://github.com/Corsinvest/cv4pve-report) ⭐ 57 | 🐛 2 | 🌐 C# | 📅 2026-06-01 - Export Proxmox VE infrastructure to a navigable Excel, HTML or JSON report - like RVTools for Proxmox.
...
* [Proxmox VE Custom Integration for Home Assistant](https://github.com/dougiteixeira/proxmoxve) ⭐ 963 | 🐛 45 | 🌐 Python | 📅 2026-08-14 - This integration allows you to poll various data and controls from your Proxmox VE instance.
* [Proxmox Extended Sensors (v4)](https://github.com/Javisen/proxmox_sensors) ⭐ 64 | 🐛 14 | 🌐 Python | 📅 2026-08-17 - Detailed monitoring & control system for Proxmox VE & PBS in Home Assistant.
...
* [Proxmox Hardening Guide](https://github.com/HomeSecExplorer/Proxmox-Hardening-Guide) ⭐ 557 | 🐛 0 | 📅 2026-02-09 - Security hardening guides for PVE and PBS, built on CIS Debian Benchmark with Proxmox specific best practices.
...
* [Proxmox VE Plugin for Pure Storage as Multipath iSCSI Source](https://github.com/kolesa-team/pve-purestorage-plugin) ⭐ 42 | 🐛 12 | 🌐 Perl | 📅 2026-09-06 - Integration of Pure Storage arrays with Proxmox Virtual Environment (VE) using multipath iSCSI or Fibre Channel (FC).
...
* [PVE-VDIClient](https://github.com/joshpatten/PVE-VDIClient) ⭐ 1,089 | 🐛 44 | 🌐 Python | 📅 2026-04-10 - Proxmox based VDI client.
...
Contributing guidelines can be found [here](https://github.com/alexgoesgit/awesome-proxmox-ve-virtualization/blob/main/contributing.md) ⭐ 82 | 🐛 1 | 📅 2026-09-04.
