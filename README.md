...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 514 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* Go
  ...
  * [go-proxmox](https://github.com/luthermonson/go-proxmox) ⭐ 283 | 🐛 2 | 🌐 Go | 📅 2026-08-09 - Typed Go client for the Proxmox VE REST API.
* Java
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 515 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,455 | 🐛 19 | 🌐 Shell | 📅 2026-08-31 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,923 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-31 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,897 | 🐛 17 | 🌐 Shell | 📅 2026-08-23 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
...
* [PVE Scripts Local](https://github.com/community-scripts/ProxmoxVE-Local) ⭐ 372 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-21 - Local web UI to browse and run Proxmox VE Helper-Scripts without curl-to-bash from the site.
* [dockur/proxmox](https://github.com/dockur/proxmox) ⭐ 303 | 🐛 3 | 🌐 Shell | 📅 2026-08-30 - Full Proxmox VE node running inside a Docker container, for labs and CI.
...
* [ProxLB](https://github.com/credativ/ProxLB) ⭐ 161 | 🐛 9 | 🌐 Python | 📅 2026-08-31 - Application to optimize the distribution of virtual machines across Proxmox cluster nodes for enhanced efficiency and performance.
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,207 | 🐛 115 | 🌐 Go | 📅 2026-08-31 - Terraform provider which adds support for Proxmox solutions.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 579 | 🐛 0 | 🌐 Ruby | 📅 2026-08-30 - Self-contained GitOps environment for provisioning and orchestrating Linux Containers (LXC) on Proxmox VE.
* [Cluster API Provider for Proxmox VE (CAPMOX)](https://github.com/ionos-cloud/cluster-api-provider-proxmox) ⭐ 477 | 🐛 117 | 🌐 Go | 📅 2026-08-31 - Kubernetes-style declarative APIs for cluster creation, configuration, and management on Proxmox VE.
* [Pulumi Proxmox VE](https://github.com/muhlba91/pulumi-proxmoxve) ⭐ 225 | 🐛 25 | 🌐 Go | 📅 2026-08-31 - Pulumi provider for creating and managing Proxmox VE resources.
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,650 | 🐛 32 | 🌐 Go | 📅 2026-08-31 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
* [Prometheus Proxmox VE Exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) ⭐ 1,448 | 🐛 32 | 🌐 Python | 📅 2026-08-28 - Exporter that exposes information gathered from Proxmox VE nodes for use by the Prometheus monitoring system.
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 200 | 🐛 7 | 🌐 Python | 📅 2026-08-28 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
...
* [Proxmox Extended Sensors (v4)](https://github.com/Javisen/proxmox_sensors) ⭐ 62 | 🐛 14 | 🌐 Python | 📅 2026-08-17 - Detailed monitoring & control system for Proxmox VE & PBS in Home Assistant.
...
* [PVE-VDIClient](https://github.com/joshpatten/PVE-VDIClient) ⭐ 1,087 | 🐛 44 | 🌐 Python | 📅 2026-04-10 - Proxmox based VDI client.
