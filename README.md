...
* [ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) ⭐ 513 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - MCP and OpenAPI integration to safely control Proxmox VE VMs, LXCs, backups, and snapshots from LLMs and AI agents.
...
* [Proximo](https://github.com/john-broadway/proximo) ⭐ 41 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - MCP server for Proxmox VE, Backup Server, Mail Gateway, and Datacenter Manager with audited trust core (plan, prove, undo, diagnose). MCP + A2A.
...
* Go
  ...
  * [go-proxmox](https://github.com/luthermonson/go-proxmox) ⭐ 282 | 🐛 2 | 🌐 Go | 📅 2026-08-09 - Typed Go client for the Proxmox VE REST API.
* Java
...
* [proxmox-backup](https://github.com/tis24dev/proxmox-backup) ⭐ 515 | 🐛 2 | 🌐 Go | 📅 2026-08-28 - Backup tool for Proxmox PBS & PVE System Files with advanced features and notifications.
...
* [Proxmox VE Helper-Scripts](https://github.com/community-scripts/ProxmoxVE) ⭐ 29,436 | 🐛 37 | 🌐 Shell | 📅 2026-08-30 - Community-driven initiative that simplifies the setup of Proxmox Virtual Environment (VE).
* [ProxMenux](https://github.com/MacRimi/ProxMenux) ⭐ 2,920 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-30 - Management tool for Proxmox VE that simplifies system administration through an interactive menu.
* [PVE-mods](https://github.com/Meliox/PVE-mods) ⭐ 1,897 | 🐛 16 | 🌐 Shell | 📅 2026-08-23 - Small collection of scripts and mods for Proxmox Virtual Environment (PVE).
...
* [pvetui](https://github.com/devnullvoid/pvetui) ⭐ 716 | 🐛 12 | 🌐 Go | 📅 2026-08-27 - Terminal User Interface for Proxmox Virtual Environment.
* [PVE Scripts Local](https://github.com/community-scripts/ProxmoxVE-Local) ⭐ 372 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - Local web UI to browse and run Proxmox VE Helper-Scripts without curl-to-bash from the site.
* [dockur/proxmox](https://github.com/dockur/proxmox) ⭐ 300 | 🐛 3 | 🌐 Shell | 📅 2026-08-30 - Full Proxmox VE node running inside a Docker container, for labs and CI.
...
* [ProxLB](https://github.com/credativ/ProxLB) ⭐ 161 | 🐛 12 | 🌐 Python | 📅 2026-08-29 - Application to optimize the distribution of virtual machines across Proxmox cluster nodes for enhanced efficiency and performance.
...
* [Terraform Provider for Proxmox](https://github.com/bpg/terraform-provider-proxmox) ⭐ 2,206 | 🐛 117 | 🌐 Go | 📅 2026-08-30 - Terraform provider which adds support for Proxmox solutions.
...
* [Cluster API Provider for Proxmox VE (CAPMOX)](https://github.com/ionos-cloud/cluster-api-provider-proxmox) ⭐ 476 | 🐛 117 | 🌐 Go | 📅 2026-08-26 - Kubernetes-style declarative APIs for cluster creation, configuration, and management on Proxmox VE.
* [Pulumi Proxmox VE](https://github.com/muhlba91/pulumi-proxmoxve) ⭐ 225 | 🐛 25 | 🌐 Go | 📅 2026-08-30 - Pulumi provider for creating and managing Proxmox VE resources.
...
* [Pulse](https://github.com/rcourtman/Pulse) ⭐ 6,643 | 🐛 29 | 🌐 Go | 📅 2026-08-30 - Real-time monitoring for Proxmox VE, Proxmox Mail Gateway, PBS, and Docker infrastructure with alerts and webhooks.
* [Prometheus Proxmox VE Exporter](https://github.com/prometheus-pve/prometheus-pve-exporter) ⭐ 1,446 | 🐛 32 | 🌐 Python | 📅 2026-08-28 - Exporter that exposes information gathered from Proxmox VE nodes for use by the Prometheus monitoring system.
* [PVE-UPS](https://github.com/ffind-dev/pve-ups) ⭐ 198 | 🐛 5 | 🌐 Python | 📅 2026-08-28 - GUI-based UPS shutdown appliance for Proxmox VE - a NUT alternative with a web wizard and no config files
* [check\_pve](https://github.com/nbuchwitz/check_pve) ⭐ 134 | 🐛 10 | 🌐 Python | 📅 2026-02-05 - Icinga check command for Proxmox VE via API.
* [pbs-exporter](https://github.com/natrontech/pbs-exporter) ⭐ 59 | 🐛 8 | 🌐 Go | 📅 2026-08-24 - Prometheus exporter for Proxmox Backup Server.
...
* [Proxmox Hardening Guide](https://github.com/HomeSecExplorer/Proxmox-Hardening-Guide) ⭐ 548 | 🐛 0 | 📅 2026-02-09 - Security hardening guides for PVE and PBS, built on CIS Debian Benchmark with Proxmox specific best practices.
